...
@Component({
  selector: 'app-deployment-map',
  templateUrl: './deployment-map.component.html',
  styleUrls: ['./deployment-map.component.css']
})
export class DeploymentMapComponent implements OnInit {
